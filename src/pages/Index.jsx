...
export default function Index({ history }) {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://api.xfactorproductions.ng/wp-json/wp/v2/video-post")
      .then((res) => {
        let ep = [];
        res.data?.map((d) =>
          ep.push({
            ...
            content:
              d?.content?.rendered?.length > 400
                ? d?.content?.rendered?.substring(0, 400)
                : d?.content?.rendered,
          })
        );
        setVideoPost(ep);
          ...
          <div className="hero-area th-fullpage" data-parallax="scroll">
            ...
            >
              <div className="row">
                ...
                >
                  <h1>
                    Uplifting the Artistic Offerings of the African Continent
                  </h1>
                  <Link
                    className="btn btn-default btn-main mt-4"
                    to="/about"
                    role="button"
                  >
                    Know More
              ...
              <div className="col-md-6 col-xs-12">
                <div className="content">
                  ...
                  <p className="case-description">
                    X Factor Productions is a boutique entertainment company
                    specializing in talent development, artistes management,
                    event planning, advertising and media consultancy.
                  </p>
                  <p>
                    Located in the city of Lagos, with our international concern
                    represented in London, United Kingdom, our desire is to
                    build a global brand with strategic partnerships that uplift
                    the artistic offerings of the African continent{" "}
                  </p>

                  <Link
                    className="btn btn-default btn-services"
                    to="/about"
                    role="button"
                  >
                    Know More
                      ...
                      <div className="row">
                        ...
                        <div className="col-xs-12 col-md-12 col-lg-4">
                          <div className="blog-sidbar">
                            <div
                              className="related-post widgets"
