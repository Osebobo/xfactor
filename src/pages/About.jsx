                        ...
                        <div class="section py-5" style={{ marginBottom: '5em' }}>
                            <div className="content row">
                                ...
                                <div className="col-xs-12 col-sm-12 col-md-6">
                                    ...
                                    <p style={{ color: 'rgb(54, 54, 54' }}>PJWE’s mission is to create an entertainment platform that enables individuals, companies and communities excel across Africa. </p>
                                    <h3 style={{ padding: '2em 0' }}>Our Vision </h3>

                                    <p style={{ color: 'rgb(54, 54, 54' }}> PJWE’s vision is to make it easier for individuals and companies to achieve relevance through entertainment across Africa and around the world
